...
|---|---|---|
| A | resident files (20 B, ~100 B JSON, 400 B binary, Unicode name) | exact, Excellent |
...
| G | JPEG whose clusters were zeroed after deletion (TRIM simulation) | `$Bitmap` still free, validation fails, ≤ Very poor |
